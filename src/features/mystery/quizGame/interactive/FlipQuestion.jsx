...
const FlipQuestion = ({
  ...
  >
    ...
    >
      ...
      >
        {(question.timerLabel || localizedQuestion.timerLabel || 'Time')}:
        {' '}
        {formatElapsedTime(memoryState.completedMs ?? memoryState.elapsedMs)}
      </div>
    </div>
    <div
      style={{
    ...
    {memoryState.modalOpen && (
      ...
      >
        ...
        >
          ...
          >
            {(question.completedLabel || localizedQuestion.completedLabel || 'Completed in')}
            {' '}
            {formatElapsedTime(memoryState.completedMs)}
          </div>
          <div
            style={{
              fontFamily: 'var(--font-main)',
