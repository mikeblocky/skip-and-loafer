/**
 * App-wide UI text — all 7 supported languages.
 *
 * Add / edit translations here. Each language key must have the same shape as `en`.
 * Missing keys fall back to English automatically via `getUI(lang)`.
 */
...
export const UI = {
  en: {
    ...
    settings: 'Settings',
    language: 'Language',
    tip: 'Tip: use number keys to jump tabs quickly.',
    ...
    widerSpacingMode: 'Wider spacing',
    focusWidthMode: 'Narrow column',
    themePaper: 'Paper',
    themeSepia: 'Sepia',
    themeNight: 'Night',
  ...
  es: {
    ...
    settings: 'Ajustes',
    language: 'Idioma',
    tip: 'Consejo: usa las teclas numéricas para cambiar de pestaña.',
  ...
  pt: {
    ...
    darkMode: 'Modo escuro confortável',
    ...
    settings: 'Ajustes',
    language: 'Idioma',
    tip: 'Dica: use as teclas numéricas para trocar de aba.',
  ...
  fr: {
    ...
    darkMode: 'Mode sombre confortable',
    ...
    settings: 'Paramètres',
    language: 'Langue',
    tip: "Astuce : utilisez les touches numériques pour changer d'onglet.",
  ...
  de: {
    ...
    darkMode: 'Angenehmer Dunkelmodus',
    ...
    language: 'Sprache',
    tip: 'Tipp: Verwende die Zahlentasten, um den Tab zu wechseln.',
  ...
  it: {
    ...
    darkMode: 'Modalità scura confortevole',
    ...
    language: 'Lingua',
    tip: 'Suggerimento: usa i tasti numerici per cambiare scheda.',
...
/** Returns the UI locale for the given language code, falling back to English. */
export const getUI = (lang) => UI[lang] || UI.en;

/** Returns the list of language options for the settings screen. */
export const getLanguageOptions = () =>
  getSupportedUiLanguages().map((code) => ({
    code,
    name: UI[code]?.languageName || code,
  }));
