...
const INSTRUCTIONS = {
  ...
  rhythm: L(
    'Tap 4 times in the rhythm that feels most like you.',
  ...
  reaction: L(
    'Start the reflex check, wait for the signal, then tap as fast as you can.',
...
const QUESTIONS = [
  ...
  { id: 2056, type: 'hold', pairKey: 'hold-home', pairSlot: 'a', text: L('Hold until the amount of personal space you still want, even when you feel safe, feels honest.', 'Mantén hasta que la cantidad de cercanía que pide tu modo de casa se sienta correcta.', 'Segure ate a quantidade de proximidade que seu modo de casa pede parecer certa.', 'Maintiens jusqu a ce que la dose de proximite voulue a la maison semble juste.', 'Halte bis sich das Mass an Nahe fur deinen Heimmodus richtig anfuhlt.', 'Tieni premuto finche la quantita di vicinanza che il tuo modo di casa desidera sembra giusta.'), lowLabel: L('Stay close to warmth', 'Espacio privado', 'Espaco privado', 'Espace prive', 'Privater Raum', 'Spazio privato'), highLabel: L('Still want my own space', 'Cercania suave', 'Proximidade suave', 'Proximite douce', 'Sanfte Nahe', 'Vicinanza dolce'), lowModifiers: { warmth: 12, comfort: 6 }, highModifiers: { independence: 14, curiosity: 4 } },
  { id: 2057, type: 'rhythm', pairKey: 'rhythm-room', pairSlot: 'a', text: L('Tap 4 times in the rhythm that matches how quickly you warm up to a new room.', 'Toca 4 veces con el ritmo que realmente tiene tu energía en una sala.', 'Toque 4 vezes com o ritmo que sua energia no ambiente realmente tem.', 'Tape 4 fois avec le rythme que ton energie a vraiment dans une piece.', 'Tippe 4 Mal im Tempo das deine Energie im Raum wirklich hat.', 'Tocca 4 volte con il ritmo che la tua energia ha davvero in una stanza.'), slowLabel: L('Warm up slowly', 'Medido', 'Medido', 'Mesure', 'Bedachtig', 'Misurato'), fastLabel: L('Settle in fast', 'Inmediato', 'Imediato', 'Immediat', 'Unmittelbar', 'Immediato'), steadyLabel: L('Pretty consistent', 'Estable', 'Estavel', 'Stable', 'Konstant', 'Stabile'), wildLabel: L('Changes room to room', 'Irregular', 'Irregular', 'Saccade', 'Sprunghaft', 'A scatti'), slowModifiers: { vigilance: 10, comfort: 4, independence: 2 }, fastModifiers: { play: 10, warmth: 8, curiosity: 4 }, steadyModifiers: { comfort: 8, warmth: 4, vigilance: 4 }, wildModifiers: { play: 8, curiosity: 8, comfort: -4 } },
  ...
  { id: 2060, type: 'hold', pairKey: 'hold-recovery', pairSlot: 'a', text: L('Hold until the amount of quiet you need after a heavy day feels honest.', 'Mantén hasta que la cantidad de soledad que necesita tu recarga se sienta honesta.', 'Segure ate a quantidade de solidao que sua recarga precisa parecer honesta.', 'Maintiens jusqu a ce que la dose de solitude dont ta recharge a besoin semble juste.', 'Halte bis sich das Mass an Alleinsein fur deinen Reset ehrlich anfuhlt.', 'Tieni premuto finche la quantita di solitudine di cui la tua ricarica ha bisogno sembra giusta.'), lowLabel: L('I reset near people', 'Quedar cerca del calor', 'Ficar perto do calor', 'Rester pres de la chaleur', 'In der Nahe von Warme bleiben', 'Restare vicino al calore'), highLabel: L('I need real quiet', 'Necesito distancia tranquila', 'Preciso de distancia tranquila', 'Besoin d espace calme', 'Brauche ruhigen Abstand', 'Ho bisogno di distanza calma'), lowModifiers: { warmth: 10, comfort: 6 }, highModifiers: { independence: 12, vigilance: 6, comfort: 2 } },
  { id: 2061, type: 'rhythm', pairKey: 'rhythm-reset', pairSlot: 'a', text: L('Tap 4 times in the rhythm that matches how you usually come back to yourself after stress.', 'Toca 4 veces con el ritmo que suele tener tu recuperación.', 'Toque 4 vezes no ritmo que sua recuperacao costuma ter.', 'Tape 4 fois au rythme que ta recuperation prend d habitude.', 'Tippe 4 Mal im Tempo das deine Erholung normalerweise hat.', 'Tocca 4 volte al ritmo che il tuo recupero di solito ha.'), slowLabel: L('Take a while', 'Asentarse lento', 'Assentar devagar', 'Calme lent', 'Langsam beruhigen', 'Calmarsi piano'), fastLabel: L('Back quickly', 'Rebote rapido', 'Recuperacao rapida', 'Rebond rapide', 'Schneller Aufschwung', 'Ripresa rapida'), steadyLabel: L('Mostly even', 'Parejo', 'Constante', 'Regulier', 'Gleichmassig', 'Regolare'), wildLabel: L('In waves', 'Irregular', 'Irregular', 'Irregulier', 'Unruhig', 'Irregolare'), slowModifiers: { comfort: 10, vigilance: 4, independence: 2 }, fastModifiers: { play: 8, warmth: 6, curiosity: 6 }, steadyModifiers: { comfort: 8, warmth: 4, vigilance: 4 }, wildModifiers: { curiosity: 8, play: 6, comfort: -4 } },
  { id: 2062, type: 'reaction', pairKey: 'reaction-instinct', pairSlot: 'a', text: L('Test your reflex. Once the signal is real, how quickly do you move?', 'Prueba tu reflejo instintivo. Que tan rapido te mueves cuando la senal es real?', 'Teste seu reflexo instintivo. Quao rapido voce se move quando o sinal e real?', 'Teste ton reflexe instinctif. A quelle vitesse bouges-tu quand le signal est reel ?', 'Teste deinen Instinkt-Reflex. Wie schnell bewegst du dich, wenn das Signal echt ist?', 'Metti alla prova il tuo riflesso istintivo. Quanto in fretta ti muovi quando il segnale e reale?'), quickLabel: L('Instant', 'Instantaneo', 'Instantaneo', 'Instantane', 'Sofort', 'Istantaneo'), steadyLabel: L('Measured', 'Medido', 'Misurato', 'Mesure', 'Bedacht', 'Misurato'), slowLabel: L('Late', 'Tardio', 'Tardio', 'Retarde', 'Verzoegert', 'In ritardo'), fastCutoffMs: 280, steadyCutoffMs: 520, quickModifiers: { play: 15, curiosity: 12, warmth: 6, vigilance: -2 }, slowModifiers: { vigilance: 3, comfort: 2, independence: 1, play: -8 }, falseStartModifiers: { play: -2, curiosity: 2, vigilance: -10, comfort: -8 } },
  { id: 2063, type: 'timing', pairKey: 'timing-control', pairSlot: 'a', text: L('Stop the meter inside the target zone and see how clean your timing feels.', 'Deten el medidor dentro de la zona objetivo para probar tu sincronizacion.', 'Pare o medidor dentro da zona alvo para testar seu tempo.', 'Arrete la jauge dans la zone cible pour tester ton timing.', 'Stoppe den Taktgeber in der Zielzone, um dein Timing zu testen.', 'Ferma il misuratore all interno della zona bersaglio per testare il tuo tempismo.'), bullseyeLabel: L('Bullseye', 'Centro exacto', 'Centro exato', 'Plein centre', 'Volltreffer', 'Centro pieno'), nearLabel: L('Close', 'Cerca', 'Perto', 'Proche', 'Nah dran', 'Vicino'), wideLabel: L('Missed wide', 'Lejos', 'Longe', 'Large', 'Daneben', 'Largo'), targetProgress: 0.68, targetTolerance: 0.24, bullseyeThreshold: 0.82, nearThreshold: 0.55, bullseyeModifiers: { vigilance: 14, comfort: 8, independence: 6 }, nearModifiers: { curiosity: 6, vigilance: 4, play: 1 }, wideModifiers: { play: -2, warmth: -2, vigilance: -6, comfort: -4 } },
];

const RECOVERY = [
  { id: 2901, type: 'yesno', isRecoveryItem: true, pairKey: 'recovery-social', pairSlot: 'a', text: L('Even when I feel good, I still prefer a few trusted bonds over a wide circle.', 'Incluso en mi mejor version, prefiero pocos vinculos seguros.', 'Mesmo no meu melhor, prefiro poucos vinculos seguros.', 'Meme a mon meilleur, je prefere quelques liens surs.', 'Selbst in Bestform bevorzuge ich wenige sichere Bindungen.', 'Anche al mio meglio preferisco pochi legami sicuri.'), yesModifiers: { independence: 10, comfort: 6, warmth: 2 }, noModifiers: { warmth: 10, play: 4, independence: -4 } },
  { id: 2902, type: 'yesno', isRecoveryItem: true, pairKey: 'recovery-social', pairSlot: 'b', pairReverse: true, text: L('When a room feels safe, I get noticeably more playful.', 'Cuando una sala se siente segura, me vuelvo mucho mas jugueton.', 'Quando um ambiente parece seguro, fico muito mais brincalhao.', 'Quand une piece semble sure, je deviens bien plus joueur.', 'Wenn sich ein Raum sicher anfuhlt werde ich viel verspielter.', 'Quando una stanza sembra sicura, divento molto piu giocoso.'), yesModifiers: { warmth: 10, play: 10 }, noModifiers: { vigilance: 8, independence: 6, warmth: -4 } },
  { id: 2903, type: 'spectrum', isRecoveryItem: true, pairKey: 'recovery-rhythm', pairSlot: 'a', text: L('If free time suddenly opens up, what pulls at you first?', 'Tiempo libre inesperado: que llama primero?', 'Tempo livre inesperado: o que chama primeiro?', 'Temps libre inattendu : qu est-ce qui appelle d abord ?', 'Unerwartete freie Zeit: was ruft zuerst?', 'Tempo libero inatteso: cosa chiama per prima?'), labelKey: 'comfortAdventure', left: { modifiers: { comfort: 14, vigilance: 4 } }, right: { modifiers: { curiosity: 14, independence: 6, play: 2 } } },
  { id: 2904, type: 'choice', isRecoveryItem: true, text: L('Which statement feels closest to your steady baseline?', 'Que frase se acerca mas a tu base estable?', 'Qual frase chega mais perto da sua base estavel?', 'Quelle phrase est la plus proche de ta base stable ?', 'Welche Aussage liegt deiner stabilen Grundlinie am nachsten?', 'Quale frase e piu vicina alla tua base stabile?'), optionKey: 'homeModes' },
  { id: 2905, type: 'allocation', isRecoveryItem: true, budget: 10, text: L('Distribute 10 points across what feels most fundamentally true for you.', 'Distribuye 10 puntos en lo que se siente fundamentalmente cierto.', 'Distribua 10 pontos no que parece fundamentalmente verdadeiro.', 'Distribue 10 points sur ce qui semble fondamentalement vrai.', 'Verteile 10 Punkte auf das was sich grundlegend wahr anfuhlt.', 'Distribuisci 10 punti su cio che sembra fondamentalmente vero.'), optionKey: 'allocCore' },
  { id: 2906, type: 'grid', isRecoveryItem: true, text: L('On your calmest day, which square still feels true?', 'Que cuadro sigue sonando cierto en tu dia mas calmo?', 'Qual quadrado ainda parece verdadeiro no seu dia mais calmo?', 'Quelle case sonne encore juste lors de ton jour le plus calme ?', 'Welches Feld klingt an deinem ruhigsten Tag noch wahr?', 'Quale riquadro suona ancora vero nel tuo giorno piu calmo?'), gridKey: 'socialNest' },
];
