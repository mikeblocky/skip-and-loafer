            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  borderRadius: '14px',
                  cursor: 'pointer',
                  border: isActive ? `2.5px solid ${theme.border}` : `2.5px solid var(--themed-card-inactive-border, #cbd5e1)`,
                  borderRight: isActive ? `4.5px solid ${theme.border}` : `2.5px solid var(--themed-card-inactive-border, #cbd5e1)`,
                  borderBottom: isActive ? `6px solid ${theme.border}` : `4.5px solid var(--themed-card-inactive-border, #cbd5e1)`,
