export const UI_TEXT = {
  ...
  es: { header: 'Blog', listHint: 'Últimas publicaciones y transcripciones', readPost: 'Leer blog', backToList: 'Volver a blogs', noBlogs: 'Aún no hay blogs.', empty: 'No hay contenido disponible.', minutesRead: 'min de lectura', returnToTop: 'Arriba' },
  pt: { header: 'Blog', listHint: 'Últimas postagens e transcrições', readPost: 'Ler blog', backToList: 'Voltar aos blogs', noBlogs: 'Ainda não há blogs.', empty: 'Nenhum conteúdo disponível.', minutesRead: 'min de leitura', returnToTop: 'Topo' },
  fr: { header: 'Blog', listHint: 'Derniers billets et transcriptions', readPost: 'Lire le blog', backToList: 'Retour aux blogs', noBlogs: 'Aucun blog pour le moment.', empty: 'Aucun contenu disponible.', minutesRead: 'min de lecture', returnToTop: 'Haut' },
  de: { header: 'Blog', listHint: 'Neueste Beiträge und Transkripte', readPost: 'Blog lesen', backToList: 'Zurück zu Blogs', noBlogs: 'Noch keine Blogs.', empty: 'Kein Inhalt verfügbar.', minutesRead: 'Min. Lesezeit', returnToTop: 'Nach oben' },
  it: { header: 'Blog', listHint: 'Ultimi post e trascrizioni', readPost: 'Leggi il blog', backToList: 'Torna ai blog', noBlogs: 'Nessun blog al momento.', empty: 'Nessun contenuto disponibile.', minutesRead: 'min di lettura', returnToTop: 'Su' },
};
