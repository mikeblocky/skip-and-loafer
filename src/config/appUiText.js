...
export const APP_UI_TEXT = {
  en: {
    ...
    tabs: {
      ...
      sign: { label: 'Guestbook', mobileLabel: 'Guestbook' },
      fanGallery: { label: 'Fan works', mobileLabel: 'Fan works' },
  ...
  es: {
    ...
    tabs: {
      ...
      sign: { label: 'Libro', mobileLabel: 'Libro' },
      fanGallery: { label: 'Fan works', mobileLabel: 'Fan works' },
      blog: { label: 'Blog', mobileLabel: 'Blog' },
      wiki: { label: 'Wiki', mobileLabel: 'Wiki' },
      chat: { label: 'Chat', mobileLabel: 'Chat' },
  ...
  fr: {
    ...
    tabs: {
      ...
      sign: { label: "Livre d'or", mobileLabel: "Livre d'or" },
      fanGallery: { label: 'Fan works', mobileLabel: 'Fan works' },
      blog: { label: 'Blog', mobileLabel: 'Blog' },
      wiki: { label: 'Wiki', mobileLabel: 'Wiki' },
      chat: { label: 'Chat', mobileLabel: 'Chat' },
  ...
  de: {
    ...
    tabs: {
      ...
      gallery: { label: 'Galerie', mobileLabel: 'Galerie' },
      sign: { label: 'Gästebuch', mobileLabel: 'Gästebuch' },
      fanGallery: { label: 'Fan works', mobileLabel: 'Fan works' },
      blog: { label: 'Blog', mobileLabel: 'Blog' },
      wiki: { label: 'Wiki', mobileLabel: 'Wiki' },
      chat: { label: 'Chat', mobileLabel: 'Chat' },
  ...
  ja: {
    ...
    tabs: {
      ...
      sign: { label: 'ゲストブック', mobileLabel: 'ゲストブック' },
      fanGallery: { label: 'ファンワークス', mobileLabel: 'ファンワークス' },
      blog: { label: 'ブログ', mobileLabel: 'ブログ' },
      wiki: { label: 'ウィキ', mobileLabel: 'ウィキ' },
      chat: { label: 'チャット', mobileLabel: 'チャット' },
