...
// gif.js is lazy-loaded on demand (only needed when exporting GIF)
import { createPortal } from 'react-dom';
import {
  PALETTE, GROUP_COLORS, LINE_STYLES, LINE_SHAPES, ARROW_MODES, LINE_THICKNESS,
  NODE_SHAPES, NODE_SIZES, HUB_SIZES, NODE_ANIMATIONS, BACKGROUNDS,
  getNodeRadius, getAdjustedEndpoints, getMidpoint, generatePath,
} from './relationshipMapConfig';
  ...
  const handleSaveGif = async () => {
    ...
    setTimeout(async () => {
      try {
        ...
        const [workerRes, { default: GIF }] = await Promise.all([
